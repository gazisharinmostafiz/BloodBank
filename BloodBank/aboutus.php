...
<div class="cont_main">
	<div class="content">
		<img src="Images/about.png" height="70px"  />
			...
			<p><img src="Images/123.jpg" height="200px" style="margin-bottom:40px" /></a>Blood is universally recognized as the most precious element that sustains life. It saves innumerable lives across the world in a variety of conditions. The need for blood is great - on any given day, approximately 39,000 units of Red Blood Cells are needed. More than 29 million units of blood components are transfused every year. 
			Donate Blood Despite the increase in the number of donors, blood remains in short supply during emergencies,
			mainly attributed to the lack of information and accessibility. We positively believe this tool can overcome most of these challenges by
			effectively connecting the blood donors with the blood recipients.</p>
        ...
        <p class="top"> Blood Management Foundations</p>
<p>Brac University</p>
<p>CSE Department</p>
        <p class="top">Dhaka</p>
<p>Bangladesh</p>
